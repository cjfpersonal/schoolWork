...
<div class="a100">
    <el-row class="show-list-box" style="height: 70px;line-height: 70px">
       ...
       <el-col :xs="17" class="a100">
         <span style="color: #4b99ff; font-size: 22px">发布成功</span>
       </el-col>
     </el-row>
    ...
    <div class="dialog-footer" style="width: 100%; position: fixed; bottom: 0">
        <div class="half-btn-box" v-on:click="gotoRouter($event, '/home/activity')">
            <i class="map-logo logo-style1" style="transform: translateY(25%)"></i>
            <span>活动地图</span>
        </div>
        <div class="half-btn-box" @click="gotoRouter($event, '/activity/detail')">
            <i class="go-home-active-logo logo-style2" style="transform: translateY(25%)"></i>
            <span>我的活动</span>
        </div>
    </div>
</div>
